---
title: 2、HTTP调用：你考虑到超时、重试、并发了吗？
---

![image-20230625144625218](https://javaxiaobear-1301481032.cos.ap-guangzhou.myqcloud.com/picture-bed/image-20230625144625218.png)
...
客户端接口被调用的日志只输出了一次，而服务端的日志输出了两次。虽然 Feign 的默认读取超时时间是 1 秒，但客户端 2 秒后才出现超时错误。显然，这说明**客户端自作主张进行了一次重试，导致短信重复发送**。
