...
![](../../../images/1574856677.png)

此时我们就可以搜索到actiBPM插件，它就是Activiti Designer的IDEA版本，我们点击Install安装。

安装好后，页面如下：

![](../../../images/1574856972.png)

提示需要重启idea，点击重启。

重启完成后，再次打开Settings 下的 Plugins（插件列表），点击右侧的Installed（已安装的插件），在列表中看到actiBPM，就说明已经安装成功了，如下图所示：

![](../../../images/1574857172.png)

后面的课程里，我们会使用这个流程设计器进行Activiti的流程设计。



`actiBPM`在低版本IDEA2020中适用，具体请自行测试，高于这个版本的，请安装`Activiti BPMN visualizer`插件，但这个插件只能用`activiti 6`，对于activiti 7的版本，还需借用外部流程图软件；
...
![](../../../images/1572852095.png)



执行完成后我们查看数据库， 创建了 25 张表，结果如下： 

![image-20221208210344594](../../../images/image-20221208210344594.png)
